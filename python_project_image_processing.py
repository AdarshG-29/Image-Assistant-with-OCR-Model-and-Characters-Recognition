...
lbl1 = tk.Label(window, text="Welcome to Image Processing...", font=("Franklin Gothic Demi", 25), bg="black", fg="white")#HEADING
lbl1.pack()
lbl2 = tk.Label(window, text ="Choose a command from below:", font=10, bg="black", fg="white", padx=20)
lbl2.pack()


bg_image = PhotoImage(file ="Happynewyearmage.png")#HAPPY NEW YEAR IMAGE AS A BACKGROUND 
x = Label (image = bg_image,bg="#000000",width=1200,height=350)
x.pack(side=tk.BOTTOM,anchor=S)
...
def func12(): #FUNCTION WILL RETURN DETAILS OF GROUP MEMBERS
    window12 = tk.Tk()
    window12.title("Resize Image")
    window12.geometry("500x300")
    window12.configure(bg="black")
    lb12 = tk.Label(window12, text="Group Members:", font=("Arial bold",15), bg="#3DA8AA", fg="white")
    lb12.pack()
    
    lb121 = tk.Label(window12, text="~Khushi Mehta\n (2019kucp1081)", font=5, bg="black", fg="white")
    lb121.pack()
    lb121.place(x=80, y=30)
    lb122 = tk.Label(window12, text="~Priyanka Phulwari\n(2019kucp1105)", font=5, bg="black", fg="white")
    lb122.pack()
    lb122.place(x=300, y=30)
    lb123 = tk.Label(window12, text="~Adarsh Gupta\n(2019kucp1010)", font=5, bg="black", fg="white")
    lb123.pack()
    lb123.place(x=180, y=100)
    lb124 = tk.Label(window12, text="~Rajdeep Chattopadhyay\n(2019kucp1054)", font=5, bg="black", fg="white")
    lb124.pack()
    lb124.place(x=300, y=170)
    lb125 = tk.Label(window12, text="~Prateek Sharma\n(2019kucp1057)", font=5, bg="black", fg="white")
    lb125.pack()
    lb125.place(x=80, y=170)
...
btn11.pack()
btn11.place(x=105, y=380)

btn12 = tk.Button(text="Team Member Details",command=func12,font=("Arialbold"), width=26,height=1,background="#3DA8AA")#MEMBERS BUTTON
btn12.pack()
btn12.place(x=505, y=380)
